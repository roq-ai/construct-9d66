...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['project-manager', 'construction-worker', 'site-supervisor', 'safety-officer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Issue', path: '/issues', entity: 'issue', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    {
      name: 'Time Entry',
      path: '/time-entries',
      entity: 'time_entry',
